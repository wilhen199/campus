...
df = pd.read_excel('./Files/License.xlsx','Hoja1')

# Guardar el DataFrame en un archivo Excel
output_file = './Results/License_results.xlsx'
    ...
    try:
        with ConnectHandler(**device_params_local) as net_connect:
            ...
            if len(license) > 18:
                ...
                result = f"{ip_address},{expected_hostname},{current_prompt},{network +" "+network_status},{dna +" "+dna_status}"
            else:
                print(f"Salida inesperada en el comando 'show license usage' para {ip_address}")
...
header = ['ip_address', 'expected_hostname', 'prompt', 'license_network','license_dna']  # Definir el encabezado del archivo
