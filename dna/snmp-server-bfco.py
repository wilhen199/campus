...
df = pd.read_excel('./Files/snmp_server.xlsx','Hoja1')

# Guardar el DataFrame en un archivo Excel
output_file = './Results/snmp_server_results.xlsx'
...
def verify_device(row):
    ...
    pprint(f"Conectando a {ip_address}... (thread {threading.get_ident()})")
    try:
        with ConnectHandler(**device_params_local) as net_connect:
            ...
            cmd = "snmp-server host 10.120.8.18 version 2c ch1kg0"
            ...
            result = f"{ip_address},{expected_hostname},{current_prompt},Configuracion OK"
